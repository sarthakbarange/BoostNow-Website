...
import appointmentGif from '/public/icons8-tear-off-calendar.gif';
  ...
  return (
    <section id={id} className="max-w-7xl mx-auto p-8 text-white rounded-2xl mt-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-5"> 
        ...
        {/* MODIFIED: Appointment Card with new background color */}
        <div 
          onClick={() => setShowPopup(true)} 
          className="group flex flex-col items-center justify-center bg-[#1b2332] p-6 rounded-2xl transform hover:scale-[1.01] transition-all duration-300 cursor-pointer"
        >
          {/* Container for larger GIF */}
          <div className="flex justify-center items-center w-full h-56">
              {/* Increased GIF size */}
              <img src={appointmentGif} alt="Book Appointment" className="w-52 h-52" />
          </div>
          <h3 className="text-2xl font-bold text-white mt-4 mb-1 group-hover:text-blue-300 transition-colors duration-300">Appointment &rarr;</h3>
          <p className="text-white text-center px-4 mb-2">Schedule an appointment with our experts.</p>
        </div>

        {/* MODIFIED: FAQ Card with new background color */}
        <Link 
          to="/faq" 
          className="group flex flex-col items-center bg-[#1b2332] p-6 rounded-2xl transform hover:scale-[1.01] transition-all duration-300"
        >
          {/* Container for larger GIF */}
          <div className="flex justify-center items-center w-full h-56">
              {/* Increased GIF size */}
              <img src={faq} alt="FAQ" className="w-52 h-52" />
          </div>
          <h3 className="text-2xl font-bold text-white mt-4 mb-1 group-hover:text-blue-300 transition-colors duration-300">FAQ &rarr;</h3>
          <p className="text-white text-center px-4 mb-2">Find answers to frequently asked questions.</p>
        </Link>
      </div>
