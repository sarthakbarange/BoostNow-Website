...
        {/* Get Support - REMOVED FOR BREVITY in previous revision */}

        {/* Appointment Popup Trigger (UPDATED TO USE GIF) */}
...
          <div className="flex justify-center items-center w-full h-48 sm:h-56 bg-white rounded-t-2xl">
                {/* NEW: Replaced placeholder illustration with the imported GIF */}
              <img src={appointmentGif} alt="Book Appointment" className="w-40 h-40" />
          </div>
