...
export default function TalentSupportServices() {
  return (
    <div className="flex flex-col min-h-screen">
      <main className="flex-grow text-white container mx-auto px-4 py-8">
        <h2 className="text-4xl sm:text-6xl font-bold mb-8 text-center">Talent Support</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <ServiceCard
            ...
            link="/services/itservices/talentsupport"
          />
          <ServiceCard
