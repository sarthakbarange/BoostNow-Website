...
const HeroSection = () => {
  const [lottieRef, isLottieVisible] = useInView({ threshold: 0.1 })
  ...
  return (
    <div>
      ...
      >
        ...
        {/* Lottie/GIF Animations */}
        <div ref={lottieRef} className="sm:w-20 sm:h-20 absolute md:block md:top-[25%] top-[10%] md:left-[10%] left-[2%] z-10">
          <img
        ...
        <div className="text-center w-full text-white relative md:mt-32 z-10">
          <h1
            className="text-3xl sm:text-5xl font-bold flex flex-wrap justify-center gap-2"
            data-aos="fade-down"
          >
            <span>ELEVATE YOUR</span>
            <span className="text-blue-400">
              <Typewriter
                words={[" BRAND", " BUSINESS", " SUCCESS"]}
          ...
          <p
            className="mt-4 sm:mt-8 text-base sm:text-lg text-gray-300"
            data-aos="fade-down"
            data-aos-delay="200"
          >
          ...
          <div className="mt-4 sm:mt-6 flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center">
            <Link
              to="/contact"
              className="rounded-full px-5 sm:px-6 py-2 sm:py-3 bg-cyan-500 text-white font-medium hover:bg-gray-600 transition text-sm sm:text-base"
            >
              Schedule a Call
            </Link>
            <Link
